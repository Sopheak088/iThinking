...
namespace ProjectManagement.Company.View
{
    public partial class FrmCompanyList : Form
    {
        ...
        public void LoadData()
        {
            ...
            gridList.DataSource = CompanyDao.FilterListCompany(filterEntity);
            gridList.Refresh();
        }
        ...
        private void BtnEdit_Click(object sender, EventArgs e)
        {
            ...
            if (currentRow != null || currentRow.RowType == RowType.Record)
            {
                ...
                FrmCompany frmCompany = new FrmCompany(true, id);
                frmCompany.ShowDialog();
                if (frmCompany.SaveCompleted)
                {
                    LoadData();
        ...
        private void BtnView_Click(object sender, EventArgs e)
        {
            ...
            {
                Guid id = Guid.Parse(currentRow.Cells["ID"].Value.ToString());
                FrmCompany frmCompany = new FrmCompany(false, id);
                frmCompany.ShowDialog();
            }
        }
    }
